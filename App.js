...
import { Dimensions, StyleSheet, Text, View, PixelRatio, Image, TouchableOpacity } from 'react-native';
            ...
            renderItem={({item, index}) => {
              return(
                ...
                >
                  ...
                  {/* information */}
                  <View
                    className='absolute bottom-0 right-0 left-0 z-40 mb-3 mx-2'
                  >
                    <View
                    ...
                    >
                      ...
                      <View>
                        {/* name */}
                        <View className='mb-3'>
                          <Text className='text-white text-xl font-bold'>zay</Text>
                        </View>

                        {/* description */}
                        <View className='mb-3'>
                          <Text className='text-white text-lg w-[250px]'>{item.desc}</Text>
                        </View>

                        {/* name song */}
                        <View
                          className='flex-row items-center gap-2 w-[250px]'
                        >
                      ...
                      >
                        ...
                        >
                          <View
                            className='bg-white p-[2px] rounded-full items-center justify-center'
                          >
                            <Image 
                              source={{uri: 'https://lh3.googleusercontent.com/ogw/AKPQZvwdDLyYvI05P8R39uRv2Q5P2fJuKSREVocASETn1FU'}}
                              style={{
                                width: 35,
                                height: 35,
                                resizeMode: "contain",
                          ...
                          <View
                            className='bg-[#E14763] p-[2px] rounded-full mt-[-8px]'
                          >
