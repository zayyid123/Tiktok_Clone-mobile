...
// icon
import { HomeIcon, UsersIcon, PlusIcon, ChatBubbleBottomCenterTextIcon, UserIcon } from "react-native-heroicons/outline";

const NavigationBottom = () => {
  return (
    <View
      className='flex-row justify-between items-center p-2 z-40 border-t border-white absolute bottom-0 right-0 left-0 bg-black'
    >
      {/* home button */}
      <View
      ...
      {/* plus button */}
      <View
        className='items-center flex-row relative'
      >
